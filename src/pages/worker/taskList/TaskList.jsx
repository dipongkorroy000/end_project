  ...
  return (
    <>
      <div className="container mx-auto">
        <h1 className="text-2xl font-bold text-center mb-4 max-md:text-xl">Available Tasks</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-6 max-lg:mx-10">
            {tasks.map((task) => (
              <div key={task._id} className="card bg-base-100 shadow-xl flex">
                <figure>
                  {task.task_image_url && (
                    <img src={task.task_image_url} alt={task.task_title} className="w-full text-lg h-48 object-cover" />
                  )}
                </figure>
                <div className="card-body">
                  ...
                  <div className="card-actions justify-end mt-4">
                    <button
                      ...
                      href="#_"
                      className="relative inline-flex items-center justify-start px-5 py-2.5 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group max-md:text-sm max-md:px-2 max-md:py-1.5"
                    >
